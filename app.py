...
def result():
    if request.method == 'POST':
        ...
        strMon = ''
        if Month == 'April':
            apr = 1; aug = 0; dec = 0; feb = 0; jan = 0; jul = 0; jun = 0; mar = 0; may = 0; nov = 0; okt = 0; sep = 0; strMon = 'April'
        if Month == 'August':
            apr = 0; aug = 1; dec = 0; feb = 0; jan = 0; jul = 0; jun = 0; mar = 0; may = 0; nov = 0; okt = 0; sep = 0; strMon = 'August'
        if Month == 'December':
            apr = 0; aug = 0; dec = 1; feb = 0; jan = 0; jul = 0; jun = 0; mar = 0; may = 0; nov = 0; okt = 0; sep = 0; strMon = 'December'
        if Month == 'February':
            apr = 0; aug = 0; dec = 0; feb = 1; jan = 0; jul = 0; jun = 0; mar = 0; may = 0; nov = 0; okt = 0; sep = 0; strMon = 'February'
        if Month == 'January':
